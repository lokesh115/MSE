...
class algorithms:
    ...
    def linear_search(self, size, ranks, results):
        for res in results:
            ...
            site = res[1]
            for i in range(size):
                #print(f"in loop : {ranks[result[i]][0]}")
    ...
    def novel_approach(self, query, results):
        ...
        print(f"lin ranks : {lin_ranks}")
        print(f"sem ranks : {sem_ranks}")
        ...
        for key in lin_ranks.keys():
            ...
            total_ranks[key] = [lin_ranks[key][0]+sem_ranks[key]
                                [0], lin_ranks[key][1], titles[key]]
        print(total_ranks)
